...
const accessibleColors = getAccessibleColorScheme("deuteranopia");

export const deuteranopiaTheme = createTheme({
    ...baseThemeConfig,
    colors: {
        // Fixed primary color - no hue customization in colorblind themes
        primary: accessibleColors.blue, // Use blue as primary for deuteranopia
