...
function NewsBannersTabSkeleton() {
    return (
        <>
...
function InGameBannersTabSkeleton() {
    return (
        <>
...
function AssetPreviewerLoadingState({ defaultTab }: { defaultTab: string }) {
    return (
        <Container size="xl">
            {/* Tabs skeleton */}
...
export default function AssetPreviewerPage() {
    ...
    if (!isMediaQueryReady) {
        return <AssetPreviewerLoadingState defaultTab={defaultTab} />;
    }
