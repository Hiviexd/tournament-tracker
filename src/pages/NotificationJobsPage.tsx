...
import { INotificationJobListItem, NotificationJobStatus, NotificationProvider } from "../../interfaces/NotificationJob";
                                            ...
                                            <Table.Tbody>
                                                {jobs.map((job) => (
                                                    <Table.Tr
                                                        ...
                                                        <Table.Td>
                                                            <AttemptsBadge attempts={job.attempts} maxAttempts={job.maxAttempts} />
                                                        </Table.Td>
                                                        <Table.Td>
